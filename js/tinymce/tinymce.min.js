...
tinymce.init({
    ...
    plugins: [
        "advlist autolink lists link image charmap print preview anchor textcolor fullpage ",
        "searchreplace visualblocks code fullscreen",
        "insertdatetime media table contextmenu paste responsivefilemanager"
    ],

	toolbar1: "undo,redo,|,bold,italic,underline,formatselect,fontselect,fontsizeselect,justifyleft,justifycenter,justifyright,justifyfull,|,dctbutton",
	toolbar2: "cut,copy,paste,pastetext,pasteword,|,cleanup,|,bullist,numlist,|,table,|,outdent,indent,|,interspiresurvey,link,unlink,anchor,image,advimage,responsivefilemanager,|,forecolor,backcolor,|,|,code,syntaxhl,preview,|,cfbutton",
	external_filemanager_path:"js/tinymce/filemanager/",
	filemanager_title:"File Manager" ,
	valid_elements : '*[*]',
	valid_children : "+body[style|title|DOCTYPE]"

});

function copyText (){
    var content = tinymce.get('email_content').getContent({format : 'text'});
	/*
 ...
 //	content = content.replace(/(\r\n|\n|\r)/gm,"");
    ...
    $('#text_content').val($("#htmltotext").innerText());
